...
namespace IntegrationTest6
{
    ...
    public class MainFormForClientTests
    {
        ...
        public class ClientService
        {
            ...
            public void DeleteMeeting(string clientId, string meetingId)
            {
                _meetingDataAccess.DeleteMeeting(meetingId);
                _meetingDataAccess.GetMeetingsForClient(clientId); // Оновити список зустрічей після видалення
            }
        }
        ...
        public void DeleteMeeting_Successfully()
        {
            ...
            clientService.DeleteMeeting(clientId, selectedMeetingId);
